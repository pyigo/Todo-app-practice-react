...
class CounterButton extends Component {
  ...
  render() {
    return (
      <div className="counter">
        {/* We cannot directly pass a property or parameter to a an event listner, we need to use an arrow function and provide a reference
        and the mwthod gets called on the on click event */}
